...
namespace DotNetCore.Collections.Paginable
{
    public static class SolidPageExtensions
    {
        ...
        /// <returns></returns>
        public static PaginableDosQuery<T> ToPaginable<T>(this FromSection<T> query, int? limitedMemberCount = null, Func<FromSection<T>, FromSection<T>> additionalQueryFunc = null) where T : Entity
            => PaginableDosCollFactory.CreatePageSet<T>(query, limitedMemberCount: limitedMemberCount, additionalQueryFunc: additionalQueryFunc);
        ...
        /// <param name="additionalQueryFunc"></param>
        /// <returns></returns>
        public static PaginableDosQuery<T> ToPaginable<T>(this FromSection<T> query, int pageSize, int? limitedMemberCount = null, Func<FromSection<T>, FromSection<T>> additionalQueryFunc = null) where T : Entity
            => PaginableDosCollFactory.CreatePageSet<T>(query, pageSize, limitedMemberCount, additionalQueryFunc: additionalQueryFunc);
        ...
        public static IPage<T> GetPage<T>(this FromSection<T> query, int pageNumber, Func<FromSection<T>, FromSection<T>> additionalQueryFunc = null) where T : Entity
            => GetPage<T>(query, pageNumber, PaginableSettingsManager.Settings.DefaultPageSize, additionalQueryFunc: additionalQueryFunc);
