...
namespace DotNetCore.Collections.Paginable
{
    ...
    [SolidPageExtensionsFor(
        ormName: "FreeSql",
        sourceTypeFullName: "FreeSql.ISelect<T>",
        ...
        HasAsync = true,
        AsyncCountExpression = "(await FreeSqlHelper.CountAsync(select, cancellationToken)).AsInt32()",
        AsyncFetchExpression = "await select.Page(pageNumber, pageSize).ToListAsync(includeNestedMembers, cancellationToken)",
    ...
    public static partial class SolidPageExtensions
    {
        ...
        /// <example>
        /// <code>
        /// var page = freeSql.Select&lt;ExampleModel&gt;().GetPage(15);
